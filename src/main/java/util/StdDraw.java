...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static double factorX(double w) { return w * width  / java.lang.Math.abs(xmax - xmin);  }
    private static double factorY(double h) { return h * height / java.lang.Math.abs(ymax - ymin);  }
